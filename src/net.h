...
/** vortex: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // vortex: known sent sync-checkpoint
    ...
    // vortex: used to detect branch switches
